...
{
    private readonly ICandidateRepository _candidates; private readonly IJobPostingRepository _jobs; private readonly IJobApplicationRepository _applications; private readonly IUnitOfWork _unitOfWork;
    public ApplyForJobUseCase(ICandidateRepository candidates, IJobPostingRepository jobs, IJobApplicationRepository applications, IUnitOfWork unitOfWork) { _candidates = candidates; _jobs = jobs; _applications = applications; _unitOfWork = unitOfWork; }
