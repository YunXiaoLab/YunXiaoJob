...
{
    private readonly IUserRepository _users; private readonly IJobPostingRepository _jobs; private readonly ICompanyRepository _companies; private readonly IUnitOfWork _unitOfWork;
    public ApproveJobPostingUseCase(IUserRepository users, IJobPostingRepository jobs, ICompanyRepository companies, IUnitOfWork unitOfWork) { _users = users; _jobs = jobs; _companies = companies; _unitOfWork = unitOfWork; }
