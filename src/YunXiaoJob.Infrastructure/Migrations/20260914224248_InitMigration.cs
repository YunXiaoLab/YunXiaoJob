        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlatformRole = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedRecruiterMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobPostings_CompanyMembers_AssignedRecruiterMemberId",
                        column: x => x.AssignedRecruiterMemberId,
                        principalTable: "CompanyMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobPostings_CompanyMembers_CreatedByMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobApplications_CompanyMembers_AssignedRecruiterMemberId",
                        column: x => x.AssignedRecruiterMemberId,
                        principalTable: "CompanyMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedByMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationStatusHistories_CompanyMembers_ChangedByMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    JobApplicationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScheduledByMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StartsAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndsAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LocationOrMeetingUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Note = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    EvaluationNote = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interviews_CompanyMembers_ScheduledByMemberId",
                        column: x => x.ScheduledByMemberId,
                        principalTable: "CompanyMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobOffers_CompanyMembers_CreatedByMemberId",
                        column: x => x.CreatedByMemberId,
                        principalTable: "CompanyMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationStatusHistories_ChangedByMemberId",
                table: "ApplicationStatusHistories",
                column: "ChangedByMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationStatusHistories_JobApplicationId_CreatedAtUtc",
                table: "ApplicationStatusHistories",
                columns: new[] { "JobApplicationId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_CandidateProfiles_IsSearchable_Location",
                table: "CandidateProfiles",
                columns: new[] { "IsSearchable", "Location" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyMembers_UserId_IsActive",
                table: "CompanyMembers",
                columns: new[] { "UserId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Interviews_JobApplicationId_StartsAtUtc",
                table: "Interviews",
                columns: new[] { "JobApplicationId", "StartsAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Interviews_ScheduledByMemberId_StartsAtUtc",
                table: "Interviews",
                columns: new[] { "ScheduledByMemberId", "StartsAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_AssignedRecruiterMemberId_Status",
                table: "JobApplications",
                columns: new[] { "AssignedRecruiterMemberId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_JobPostingId_Status",
                table: "JobApplications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobOffers_CreatedByMemberId",
                table: "JobOffers",
                column: "CreatedByMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_JobOffers_JobApplicationId_Status",
                table: "JobOffers",
                columns: new[] { "JobApplicationId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_AssignedRecruiterMemberId",
                table: "JobPostings",
                column: "AssignedRecruiterMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_CompanyId_Status",
                table: "JobPostings",
                columns: new[] { "CompanyId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_CreatedByMemberId",
                table: "JobPostings",
                column: "CreatedByMemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPostingSkills_JobPostingId_Name",
